    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node [anchor=west, xshift=0.2cm] at (current page.west |- logo.west) {
            \begin{minipage}{0.65\paperwidth}\raggedright
                ...
                {\usebeamerfont{author}\usebeamercolor[white]{}\scriptsize\insertauthor}
            \end{minipage}
        };
    \end{tikzpicture}
}
...
\author[Ciaran McCreesh, Patrick Prosser and James Trimble]{\textbf{Ciaran McCreesh}, Patrick Prosser and James Trimble}
...
\begin{frame}{2D Phase Transitions}
    ...
    \only<1>{
        \input{gen-graph-2d-1}
    }

    \only<2>{
        \input{gen-graph-2d-2}
    }

    \only<3>{
        \input{gen-graph-2d-3}
    }

\end{frame}

\begin{nearlyplainframe}[t]{3D Phase Transitions?}

    \only<1>{
        \input{gen-graph-3d-1}
    }

    \only<2>{
        \input{gen-graph-3d-2}
    }

\end{nearlyplainframe}

\begin{frame}{What About Induced?}

    \only<1>{
        \input{gen-graph-induced-2d-1}
    }
    ...
    \only<3>{
        \input{gen-graph-induced-2d-3}
    }

    \only<4>{
        \input{gen-graph-induced-2d-4}
    }

    \only<5>{
        \input{gen-graph-induced-2d-5}
    }
\end{frame}

\begin{nearlyplainframe}[t]{Induced in 3D?}

    \only<1>{
        \input{gen-graph-induced-3d-1}
    }

    \only<2>{
        \input{gen-graph-induced-3d-2}
    }

\end{nearlyplainframe}

\begin{frame}{Other Solvers?}

    \only<1>{
        \input{gen-graph-alt-1}
    }

    \only<2>{
        \input{gen-graph-alt-2}
    }

    \only<3>{
        \input{gen-graph-alt-3}
    }
...
\begin{frame}{Reductions}
    ...
    \only<1>{
        \input{gen-graph-red-1}
    }

    \only<2>{
        \input{gen-graph-red-2}
    }

    \only<3>{
        \input{gen-graph-red-3}
    }

    \only<4>{
        \input{gen-graph-red-4}
    }

    \only<5>{
        \input{gen-graph-red-5}
    }

\end{frame}

\begin{frame}{Why the Weird Shape?}

    \only<1>{
        \input{gen-graph-shape-1}
    }

    \only<2>{
        \input{gen-graph-shape-2}
    }

    \only<3>{
        \input{gen-graph-shape-3}
    }

    \only<4>{
        \input{gen-graph-shape-4}
    }

    \only<5>{
        \input{gen-graph-shape-5}
    }

    \only<6>{
        \input{gen-graph-shape-6}
    }
