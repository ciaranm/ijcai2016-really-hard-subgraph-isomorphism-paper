...
plot \
        ...
        "ps100-ts150.non-induced.phase-transition-points.plot" u 1:2 w p lc rgb '#fb9a99' pt 1, \
        "ps150-ts150.non-induced.phase-transition-points.plot" u 1:2 w p lc rgb '#e31a1c' pt 2
